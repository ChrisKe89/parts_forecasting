...
def test_backtest_has_required_metrics(tmp_path):
    data = {
        ...
        "usage": pd.DataFrame([
            {"part_number":"P1","model":"M1","usage_date":pd.Timestamp("2025-01-01"),"usage_qty":2,"active_machines":10},
            {"part_number":"P1","model":"M1","usage_date":pd.Timestamp("2025-02-01"),"usage_qty":2,"active_machines":10},
            {"part_number":"P1","model":"M1","usage_date":pd.Timestamp("2025-03-01"),"usage_qty":2,"active_machines":10},
            {"part_number":"P1","model":"M1","usage_date":pd.Timestamp("2025-04-01"),"usage_qty":3,"active_machines":10},
            {"part_number":"P1","model":"M1","usage_date":pd.Timestamp("2025-05-01"),"usage_qty":3,"active_machines":10},
